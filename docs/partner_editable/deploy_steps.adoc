...
|===
Deployment can take between 25 and 90 minutes 
//TODO the _settings say 30–60 minutes - please advise.
to complete, depending on the chosen deployment option and parameter values.
...
In the following tables, parameters are listed by category and described separately for each deployment option. When you finish reviewing and customizing the parameters, choose *Next*.
